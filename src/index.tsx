...
class RichMarkdownEditor extends React.PureComponent<Props, State> {
    ...
    return (
      ...
      items
        .map((i) => {
          ...
          if (icon) {
            return (
              '<div class="suggestion-item"><span class="suggestion-item-icon">' +
              i.icon +
              "</span>" +
              i.type +
              '<span class="suggestion-item-name">(' +
  ...
  handleOpenEmojiIcons = () => {
    this.setState({
      emojiIconsOpen: true,
    });
  };

  handleCloseEmojiIcons = () => {
    if (!this.state.emojiIconsOpen) return;
    this.setState({
      emojiIconsOpen: false,
    });
  };
          ...
          <React.Fragment>
            ...
            {!readOnly && this.view && (
              <React.Fragment>
                ...
                <EmojiPopup
                  view={this.view}
                  isActive={this.state.emojiIconsOpen}
                  onClose={this.handleCloseEmojiIcons}
                  commands={this.commands}
                  dictionary={dictionary}
