...
declare function TableInsertAboveIcon({ fill, size, style, className, onClick, id, }: {
    fill: any;
    size: any;
    style: any;
    className: any;
...
declare namespace TableInsertAboveIcon {
...
//# sourceMappingURL=TableInsertAboveIcon.d.ts.map