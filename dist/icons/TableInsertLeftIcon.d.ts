...
declare function TableInsertLeftIcon({ fill, size, style, className, onClick, id, }: {
    fill: any;
    size: any;
    style: any;
    className: any;
...
declare namespace TableInsertLeftIcon {
...
//# sourceMappingURL=TableInsertLeftIcon.d.ts.map