...
declare function TableInsertRightIcon({ fill, size, style, className, onClick, id, }: {
    fill: any;
    size: any;
    style: any;
    className: any;
...
declare namespace TableInsertRightIcon {
...
//# sourceMappingURL=TableInsertRightIcon.d.ts.map